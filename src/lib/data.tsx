...
export const projects: Project[] = [
  {
    ...
    description: 'A full-featured e-commerce platform with HTML, CSS, and JavaScript.',
    imageUrl: '/ecomerce.png',
    imageHint: 'online store',
    techStack: ['HTML', 'CSS', 'JavaScript', ''],
    githubUrl: 'https://github.com/Bidya15',
    demoUrl: 'https://bidya15.github.io/E-Commerce.com/',
  },
  {
    id: 'project-2',
    title: 'Travel Website',
    description: 'A fully responsive travel website built with React.Js, Vite, and CSS.',
    imageUrl: '/Travel-Website.png',
    imageHint: 'travel website',
    techStack: ['React.Js', 'Vite', 'CSS', ''],
    githubUrl: 'https://github.com/Bidya15',
    demoUrl: 'https://travel-website-ochre-three.vercel.app/',
  },
  {
    id: 'project-3',
    title: 'Service Portal',
    description: 'A service provider platform for software developers, and job provider.',
    imageUrl: '/Service-Portal.png',
    imageHint: 'service website',
    techStack: ['React.Js', 'CSS Modules', 'Vite'],
    githubUrl: 'https://github.com/Bidya15',
    demoUrl: 'https://code-x-technologies.vercel.app/',
  },
   {
    id: 'project-4',
    title: 'Portfolio Website',
    description: 'Personal portfolio website showcasing skills and projects, built with Next.Js, Tailwind CSS, and Firebase.',
...
export const experiences: Experience[] = [
  {
    id: 'exp1',
    company: 'Entrepreneurship and Development Cell(EDC), AEC',
    title: 'Technical Associate',
    duration: 'Sept 2024 - Present',
    location: 'Assam Engineering College(AEC), Jalukbari, Ghy-13',
    description: [
      'Work as a technical associate at EDC-AEC.',
...
export const socialLinks: SocialLink[] = [
  { label: 'GitHub', href: 'https://github.com/Bidya15', Icon: Github },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/bidya-s-rongpi-2b018a27b', Icon: Linkedin },
  { label: 'Twitter', href: 'https://x.com/BidyaSi26863249', Icon: Twitter },
